...
async function parseForm(req: NextApiRequest): Promise<{ fields: Record<string, string>; file: formidable.File }> {
  ...
  return { fields: fieldMap, file: file as formidable.File }
}
