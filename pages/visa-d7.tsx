...
export default function VisaD7() {
  ...
  return (
    <>
      <Head>
        <title>D7 Passive Income Visa Portugal — WINIT</title>
        <meta name="description" content="Portugal D7 Visa for retirees and passive income: requirements, financial thresholds, and how we help. End-to-end support to residency." />
        <meta property="og:title" content="D7 Passive Income Visa Portugal — WINIT" />
        ...
        <main>
          <section className="d2-overview-section" style={{ padding: '4rem 0' }}>
            <div className="home-container fade-in-on-scroll" data-fade-in style={{ maxWidth: '720px', margin: '0 auto' }}>
              <span className="d2-section-label">D7 Visa</span>
              <h1 className="d2-heading" style={{ fontSize: 'clamp(1.75rem, 4vw, 2.25rem)' }}>D7 Passive Income Visa</h1>
              <p className="d2-body">
          ...
          <section style={{ padding: '2rem 0', background: '#fff', borderTop: '1px solid #e2e8f0' }}>
            <div className="home-container fade-in-on-scroll" data-fade-in style={{ maxWidth: '720px', margin: '0 auto' }}>
              <h2 className="d2-heading" style={{ marginBottom: '1rem' }}>Who Can Apply?</h2>
          ...
          <section style={{ padding: '2rem 0', background: '#f8fafc' }}>
            <div className="home-container fade-in-on-scroll" data-fade-in style={{ maxWidth: '720px', margin: '0 auto' }}>
              <h2 className="d2-heading" style={{ marginBottom: '1rem' }}>Core Financial Requirements (2026)</h2>
              <ul className="d2-body" style={{ paddingLeft: '1.2rem', lineHeight: 1.8 }}>
          ...
          <section style={{ padding: '2rem 0', background: '#fff', borderTop: '1px solid #e2e8f0' }}>
            <div className="home-container fade-in-on-scroll" data-fade-in style={{ maxWidth: '720px', margin: '0 auto' }}>
              <h2 className="d2-heading" style={{ marginBottom: '1rem' }}>Other Requirements</h2>
              <ul className="d2-body" style={{ paddingLeft: '1.2rem', lineHeight: 1.8 }}>
          ...
          <section style={{ padding: '3rem 0', background: 'linear-gradient(180deg, #f1f5f9 0%, #e2e8f0 100%)', textAlign: 'center' }}>
            <div className="home-container fade-in-on-scroll" data-fade-in>
              <p style={{ marginBottom: '1rem' }}>
                <Link href="/contact" className="d2-cta-primary">Get started with D7</Link>
